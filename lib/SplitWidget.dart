...
class Split extends StatefulWidget {
  ...
  const Split({
    ...
    this.dragIndicatorBackgroundColor,
  ...
  /// Background color of the drag indicator
  final Color dragIndicatorBackgroundColor;
...
class _SplitState extends State<Split> {
  ...
  Widget _buildLayout(BuildContext context, BoxConstraints constraints) {
    ...
    secondSize = secondSize.clamp(halfDivider, axisSize - halfDivider) as double;
    ...
    void resetSpacing() {
      setState(() {
        // Reset the spacing consumed by the children
        // to the initial first fraction value.
        firstFraction = widget.initialFirstFraction;
      });
    }
          ...
          Padding(
            ...
            child: DecoratedBox(
              decoration: BoxDecoration(
                color: widget.dragIndicatorColor ?? Theme.of(context).dividerColor,
    ...
    final children = [
      ...
      GestureDetector(
        ...
        child: Container(
          ...
          color: widget.dragIndicatorBackgroundColor ?? Colors.grey.shade800,
          child: Center(
            child: dragIndicator,
          ),
        ),
